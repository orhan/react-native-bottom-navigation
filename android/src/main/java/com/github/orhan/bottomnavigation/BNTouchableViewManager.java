package com.github.orhan.bottomnavigation;
...
import com.github.orhan.bottomnavigation.widget.BNTouchableView;

import android.view.MotionEvent;
import android.view.View;

/**
 * BNTouchable View Manager, forwarding touch events to JS module
 */
public class BNTouchableViewManager extends ReactViewManager {

    @Override
    public String getName() {
        return "BNTouchableView";
    }

    @Override
    public BNTouchableView createViewInstance(ThemedReactContext context) {
        final RCTEventEmitter emitter = context.getJSModule(RCTEventEmitter.class);
        return new BNTouchableView(context, new View.OnTouchListener() {
